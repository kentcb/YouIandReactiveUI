namespace Book.ViewModels.Samples.Chapter24.Sample01
{
    ...
    [Sample(
        "Idiomatic ReactiveUI unit tests",
        @"This sample demonstrates how to unit test a realistic view model (`DinosaurDetailsViewModel`) using idiomatic ReactiveUI techniques.")]
