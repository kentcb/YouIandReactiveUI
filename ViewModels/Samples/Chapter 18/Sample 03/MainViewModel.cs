namespace Book.ViewModels.Samples.Chapter18.Sample03
{
    ...
    [Sample(
        "View Model Activation: expensive resource",
        @"This sample demonstrates the use of `WhenActivated` from within a view model.

Use the buttons to switch between child views. The view model for one of the views consumes an expensive resource (CPU) where the other does not. Keep an eye on your CPU usage as you switch between the two.")]
